...
export const FRANCHISE_BRANDS: FranchiseBrand[] = [
  // 치킨전문점 (id: 1)
  { name: 'BBQ', business_type_id: 1, initial_fee: 10_000_000, education_fee: 2_000_000, deposit: 5_000_000, interior_per_sqm: 660_000, other_cost: 5_000_000, source: SOURCE, ...R0 },
  { name: '교촌치킨', business_type_id: 1, initial_fee: 15_000_000, education_fee: 3_000_000, deposit: 5_000_000, interior_per_sqm: 700_000, other_cost: 4_000_000, source: SOURCE, ...R0 },
  { name: 'BHC', business_type_id: 1, initial_fee: 5_000_000, education_fee: 2_000_000, deposit: 3_000_000, interior_per_sqm: 600_000, other_cost: 5_000_000, source: SOURCE, ...R0 },
  { name: '굽네치킨', business_type_id: 1, initial_fee: 5_000_000, education_fee: 2_000_000, deposit: 5_000_000, interior_per_sqm: 580_000, other_cost: 4_000_000, source: SOURCE, ...R0 },
  { name: '네네치킨', business_type_id: 1, initial_fee: 3_000_000, education_fee: 2_000_000, deposit: 3_000_000, interior_per_sqm: 550_000, other_cost: 3_000_000, source: SOURCE, ...R0 },
  ...
  // 피자전문점 (id: 8)
  { name: '도미노피자', business_type_id: 8, initial_fee: 15_000_000, education_fee: 5_000_000, deposit: 10_000_000, interior_per_sqm: 800_000, other_cost: 15_000_000, source: SOURCE, royalty_rate: 0.06, advertising_rate: 0.045, fees_source: '공정위 정보공개서 2024 (PDF 파싱)' },
  { name: '피자헛', business_type_id: 8, initial_fee: 10_000_000, education_fee: 4_000_000, deposit: 5_000_000, interior_per_sqm: 750_000, other_cost: 12_000_000, source: SOURCE, ...R0 },
  { name: '미스터피자', business_type_id: 8, initial_fee: 8_000_000, education_fee: 3_000_000, deposit: 5_000_000, interior_per_sqm: 700_000, other_cost: 10_000_000, source: SOURCE, ...R0 },
